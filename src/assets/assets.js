...
export const aboutInfo = [
  {
    ...
    description: 'Finding better ways to solve problems through code'
  },
  {
    icon: FaPaintBrush,
...
export const educationData = [
  {
    role: "Global Group Of Institutes, Amritsar",
    company: "2023 - Present (7.29 CGPA)",
    duration: "2023 - Present",
    description:
      "B.Tech in CSE (4th Semester)",
    color: "purple"
  },
  {
